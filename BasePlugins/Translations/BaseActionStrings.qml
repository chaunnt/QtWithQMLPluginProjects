...
QtObject {
    ...
    property QtObject baseApp: QtObject {
        ...
        //: The action for displaying side menu
        readonly property string displaySideMenu: "displaySideMenu"

        //: The action for closing side menu
        readonly property string closeSideMenu: "closeSideMenu"
